...
describe('year view with ng-model = null', function () {
  ...
  describe('where initial structure', function () {
    ...
    it('has a `<th class=`left`>` that contains a <i class="fas fa-chevron-left"></i> element', function () {
    ...
    it('has a `<th class=`right`>` that contains a <i class="fas fa-chevron-right"></i> element', function () {
